...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        {{--Product--}}
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#productDropDown"
               aria-expanded="true" aria-controls="productDropDown">
                <i class="fas fa-fw fa-cog"></i>
                <span>Product</span>
            </a>
            <div id="productDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.product.list') }}">List Product</a>
                    <a class="collapse-item" href="{{ route('admin.product.add.post') }}">Add Product</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="categoryDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.category.list') }}">List Category</a>
                    <a class="collapse-item" href="{{ route('admin.category.add.post') }}">Add Category</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#userDropDown"
               aria-expanded="true" aria-controls="userDropDown">
                <i class="fas fa-fw fa-cog"></i>
                <span>User</span>
            </a>
            <div id="userDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('admin.user.add.post') }}">Add User</a>
                </div>
            </div>
        </li>
        ...
        {{--Admin--}}
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#adminDropDown"
               aria-expanded="true" aria-controls="adminDropDown">
                <i class="fas fa-fw fa-cog"></i>
                <span>Admin</span>
            </a>
            <div id="adminDropDown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.admin.list') }}">List Admin</a>
                    <a class="collapse-item" href="{{ route('admin.admin.add.post') }}">Add Admin</a>
                </div>
            </div>
        </li>
